...
<div class="card-body">
		...
		<a href="index.php" class="btn btn-success btn-sm" type="button"><i class="bi bi-house-door"></i> Beranda</a>
	</div>
	<div class="card-body">
		<?php 
		if(isset($_GET['pesan'])){
			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							<a class="btn btn-info btn-sm" href="detail_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>"><i class="bi bi-eye"></i></a>
			...
			<form action="proses_pembelian.php" method="post">
				<div class="modal-body">				
					<div class="form-group">
						...
						<input type="text" value="<?php echo date("Ymd"). $no++ ?>" name="PelangganID" class="form-control">
					</div>
					<div class="form-group">
						<label>Nama Pelanggan</label>
